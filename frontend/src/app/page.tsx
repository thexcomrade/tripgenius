...
export default function HomePage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      location: "Kochi",
      role: "Eco Researcher",
      text: "The sustainability metrics and weather-aware packing suggestions make this genuinely innovative. It feels like an intelligent concierge, not a generic booking tool.",
      rating: 5,
    },
    {
      name: "Rahul Krishna",
